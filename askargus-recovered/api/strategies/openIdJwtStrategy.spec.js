const { SystemRoles } = require('askargus-data-provider');
...
const { findOpenIDUser } = require('@askargus/api');
...
describe('openIdJwtStrategy – OPENID_EMAIL_CLAIM', () => {
  ...
  beforeEach(() => {
    ...
    const realFindOpenIDUser = jest.requireActual('@askargus/api').findOpenIDUser;

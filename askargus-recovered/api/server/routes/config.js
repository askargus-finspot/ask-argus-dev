...
const { isEnabled, getBalanceConfig } = require('@askargus/api');
const { defaultSocialLogins } = require('askargus-data-provider');
...
function buildSharedPayload() {
  ...
  const payload = {
    appTitle: process.env.APP_TITLE || 'AskArgus',
    ...
    helpAndFaqURL: process.env.HELP_AND_FAQ_URL || 'https://askargus.ai',
    sharedLinksEnabled,

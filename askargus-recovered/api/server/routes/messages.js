...
const { unescapeLaTeX, countTokens } = require('@askargus/api');
...
router.post('/branch', async (req, res) => {
  try {
    ...
    /** @type {Array<import('askargus-data-provider').TMessageContentParts>} */
    ...
    /** @type {import('askargus-data-provider').TMessage} */
    const newMessage = {

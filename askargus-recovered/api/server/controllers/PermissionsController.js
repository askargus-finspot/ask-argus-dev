/**
 * @import { TUpdateResourcePermissionsRequest, TUpdateResourcePermissionsResponse } from 'askargus-data-provider'
 */

const mongoose = require('mongoose');
const { logger } = require('@askargus/data-schemas');
const { ResourceType, PrincipalType, PermissionBits } = require('askargus-data-provider');
const { enrichRemoteAgentPrincipals, backfillRemoteAgentPermissions } = require('@askargus/api');
const {

 ...
 * Handles MCP-specific tool endpoints, decoupled from regular AskArgus tools
 *
 * @import { MCPServerRegistry } from '@askargus/api'
 * @import { MCPServerDocument } from 'askargus-data-provider'
 */
...
const { Constants, MCPServerUserInputSchema } = require('askargus-data-provider');

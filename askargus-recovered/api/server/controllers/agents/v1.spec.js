...
const { agentSchema } = require('@askargus/data-schemas');
const { FileSources, PermissionBits } = require('askargus-data-provider');
...
const { refreshS3Url } = require('@askargus/api');

/**
 * @type {import('mongoose').Model<import('@askargus/data-schemas').IAgent>}
 */
let Agent;

...
describe('AgentClient - titleConvo', () => {
  ...
  describe('runMemory method', () => {
    ...
    it('should handle mixed content types correctly', async () => {
      ...
      const { ContentTypes } = require('askargus-data-provider');
  ...
  describe('useMemory method - prelimAgent assignment', () => {
    ...
    beforeEach(() => {
      ...
      mockCheckAccess = require('@askargus/api').checkAccess;
      mockLoadAgent = require('@askargus/api').loadAgent;
      mockInitializeAgent = require('@askargus/api').initializeAgent;
      mockCreateMemoryProcessor = require('@askargus/api').createMemoryProcessor;
    });

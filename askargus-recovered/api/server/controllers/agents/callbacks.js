...
const { Tools, StepTypes, FileContext, ErrorTypes } = require('askargus-data-provider');
const {
  EnvVar,
  Constants,
  GraphEvents,
...
/**
 * Helper to write attachment events in Open Responses format (askargus:attachment)
 * @param {ServerResponse} res - The server response object
 ...
 * Emits attachments as `askargus:attachment` events per the Open Responses extension spec.
 *
 * @param {Object} params
 * @param {ServerRequest} params.req
 * @param {ServerResponse} params.res

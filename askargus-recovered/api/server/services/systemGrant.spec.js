...
const { createModels, createMethods } = require('@askargus/data-schemas');
const { MongoMemoryServer } = require('mongodb-memory-server');
const { SystemRoles, PrincipalType } = require('askargus-data-provider');
const { SystemCapabilities } = require('@askargus/data-schemas');

jest.mock('@askargus/data-schemas', () => ({
  ...jest.requireActual('@askargus/data-schemas'),
  getTransactionSupport: jest.fn().mockResolvedValue(false),
  createModels: jest.requireActual('@askargus/data-schemas').createModels,
  createMethods: jest.requireActual('@askargus/data-schemas').createMethods,
}));

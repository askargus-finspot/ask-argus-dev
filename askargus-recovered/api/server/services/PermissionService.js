...
const { getTransactionSupport, logger } = require('@askargus/data-schemas');
const { ResourceType, PrincipalType, PrincipalModel } = require('askargus-data-provider');
const {
...
/**
 * @import { TPrincipal } from 'askargus-data-provider'
 */
/**

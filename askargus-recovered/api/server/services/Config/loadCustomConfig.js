...
const { loadYaml } = require('@askargus/api');
...
const defaultConfigPath = path.resolve(projectRoot, 'askargus.yaml');
...
https://www.askargus.ai/docs/configuration/stt_tts`);
    }

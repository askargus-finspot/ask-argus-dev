...
const { getTenantId } = require('@askargus/data-schemas');
...
// Mock @askargus/api — the real tenantContextMiddleware is TS and cannot be
...
jest.mock('@askargus/api', () => {
  const { tenantStorage } = require('@askargus/data-schemas');
  return {

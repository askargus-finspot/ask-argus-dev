...
const { checkAccess, generateCheckAccess } = require('@askargus/api');
const { PermissionTypes, Permissions } = require('askargus-data-provider');
const { getRoleByName } = require('~/models');
const { Role } = require('~/db/models');

// Mock the logger from @askargus/data-schemas

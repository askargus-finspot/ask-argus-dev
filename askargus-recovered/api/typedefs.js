 ...
 * @typedef {import('askargus-data-provider').Agents.ToolCallDelta} AgentToolCallDelta
 * @memberof typedefs
 */

/**
 * @exports ToolCallChunk
 * @typedef {import('askargus-data-provider').Agents.ToolCallChunk} ToolCallChunk
 * @memberof typedefs
 */

/**
 * @exports MessageContentImageUrl
 * @typedef {import('askargus-data-provider').Agents.MessageContentImageUrl} MessageContentImageUrl
 * @memberof typedefs
 */
...
/**
 * @exports ValidSource
 * @typedef {import('askargus-data-provider').ValidSource} ValidSource
 * @memberof typedefs
 */
...
/**
 * @exports TPrompt
 * @typedef {import('askargus-data-provider').TPrompt} TPrompt
 * @memberof typedefs
 */

/**
 * @exports TPromptGroup
 * @typedef {import('askargus-data-provider').TPromptGroup} TPromptGroup
 * @memberof typedefs
 */

/**
 * @exports TCreatePrompt
 * @typedef {import('askargus-data-provider').TCreatePrompt} TCreatePrompt
 * @memberof typedefs
 */

/**
 * @exports TCreatePromptRecord
 * @typedef {import('askargus-data-provider').TCreatePromptRecord} TCreatePromptRecord
 * @memberof typedefs
 */
/**
 * @exports TCreatePromptResponse
 * @typedef {import('askargus-data-provider').TCreatePromptResponse} TCreatePromptResponse
 * @memberof typedefs
 */
/**
 * @exports TUpdatePromptGroupResponse
 * @typedef {import('askargus-data-provider').TUpdatePromptGroupResponse} TUpdatePromptGroupResponse
 * @memberof typedefs
 */

/**
 * @exports TPromptGroupsWithFilterRequest
 * @typedef {import('askargus-data-provider').TPromptGroupsWithFilterRequest } TPromptGroupsWithFilterRequest
 * @memberof typedefs
 */

/**
 * @exports PromptGroupListResponse
 * @typedef {import('askargus-data-provider').PromptGroupListResponse } PromptGroupListResponse
 * @memberof typedefs
 */

/**
 * @exports TGetCategoriesResponse
 * @typedef {import('askargus-data-provider').TGetCategoriesResponse } TGetCategoriesResponse
 * @memberof typedefs
 */

/**
 * @exports TGetRandomPromptsResponse
 * @typedef {import('askargus-data-provider').TGetRandomPromptsResponse } TGetRandomPromptsResponse
 * @memberof typedefs
 */

/**
 * @exports TGetRandomPromptsRequest
 * @typedef {import('askargus-data-provider').TGetRandomPromptsRequest } TGetRandomPromptsRequest
 * @memberof typedefs
 */

/**
 * @exports TUpdatePromptGroupPayload
 * @typedef {import('askargus-data-provider').TUpdatePromptGroupPayload } TUpdatePromptGroupPayload
 * @memberof typedefs
 */

/**
 * @exports TDeletePromptVariables
 * @typedef {import('askargus-data-provider').TDeletePromptVariables } TDeletePromptVariables
 * @memberof typedefs
 */

/**
 * @exports TDeletePromptResponse
 * @typedef {import('askargus-data-provider').TDeletePromptResponse } TDeletePromptResponse
 * @memberof typedefs
 */
...
/**
 * @exports TRole
 * @typedef {import('askargus-data-provider').TRole } TRole
 * @memberof typedefs
 */

/**
 * @exports PermissionTypes
 * @typedef {import('askargus-data-provider').PermissionTypes } PermissionTypes
 * @memberof typedefs
 */

/**
 * @exports Permissions
 * @typedef {import('askargus-data-provider').Permissions } Permissions
 * @memberof typedefs
 */
...
/**
 * @exports Assistant
 * @typedef {import('askargus-data-provider').Assistant} Assistant
 * @memberof typedefs
 */

/**
 * @exports AssistantDocument
 * @typedef {import('askargus-data-provider').AssistantDocument} AssistantDocument
 * @memberof typedefs
 */

/**
 * @exports OpenAIFile
 * @typedef {import('askargus-data-provider').File} OpenAIFile
 * @memberof typedefs
 */

/**
 * @exports TConfig
 * @typedef {import('askargus-data-provider').TConfig} TConfig
 * @memberof typedefs
 */

/**
 * @exports TPayload
 * @typedef {import('askargus-data-provider').TPayload} TPayload
 * @memberof typedefs
 */

/**
 * @exports TAzureModelConfig
 * @typedef {import('askargus-data-provider').TAzureModelConfig} TAzureModelConfig
 * @memberof typedefs
 */

/**
 * @exports TAzureGroup
 * @typedef {import('askargus-data-provider').TAzureGroup} TAzureGroup
 * @memberof typedefs
 */

/**
 * @exports TAzureGroups
 * @typedef {import('askargus-data-provider').TAzureGroups} TAzureGroups
 * @memberof typedefs
 */

/**
 * @exports TAzureModelGroupMap
 * @typedef {import('askargus-data-provider').TAzureModelGroupMap} TAzureModelGroupMap
 * @memberof typedefs
 */
/**
 * @exports TAzureGroupMap
 * @typedef {import('askargus-data-provider').TAzureGroupMap} TAzureGroupMap
 * @memberof typedefs
 */

/**
 * @exports TAzureConfig
 * @typedef {import('askargus-data-provider').TAzureConfig} TAzureConfig
 * @memberof typedefs
 */

/**
 * @exports TModelsConfig
 * @typedef {import('askargus-data-provider').TModelsConfig} TModelsConfig
 * @memberof typedefs
 */

/**
 * @exports TStartupConfig
 * @typedef {import('askargus-data-provider').TStartupConfig} TStartupConfig
 * @memberof typedefs
 */

/**
 * @exports TConfigDefaults
 * @typedef {import('askargus-data-provider').TConfigDefaults} TConfigDefaults
 * @memberof typedefs
 */

/**
 * @exports TPlugin
 * @typedef {import('askargus-data-provider').TPlugin} TPlugin
 * @memberof typedefs
 */

/**
 * @exports TAzureConfigValidationResult
 * @typedef {import('askargus-data-provider').TAzureConfigValidationResult} TAzureConfigValidationResult
 * @memberof typedefs
 */

/**
 * @exports EImageOutputType
 * @typedef {import('askargus-data-provider').EImageOutputType} EImageOutputType
 * @memberof typedefs
 */

/**
 * @exports TCustomConfig
 * @typedef {import('askargus-data-provider').TCustomConfig} TCustomConfig
 * @memberof typedefs
 */

/**
 * @exports TProviderSchema
 * @typedef {import('askargus-data-provider').TProviderSchema} TProviderSchema
 * @memberof typedefs
 */

/**
 * @exports TBaseEndpoint
 * @typedef {import('askargus-data-provider').TBaseEndpoint} TBaseEndpoint
 * @memberof typedefs
 */

/**
 * @exports TEndpoint
 * @typedef {import('askargus-data-provider').TEndpoint} TEndpoint
 * @memberof typedefs
 */

/**
 * @exports TEndpointsConfig
 * @typedef {import('askargus-data-provider').TEndpointsConfig} TEndpointsConfig
 * @memberof typedefs
 */

/**
 * @exports TMessage
 * @typedef {import('askargus-data-provider').TMessage} TMessage
 * @memberof typedefs
 */

/**
 * @exports TConversation
 * @typedef {import('askargus-data-provider').TConversation} TConversation
 * @memberof typedefs
 */

/**
 * @exports TModelSpec
 * @typedef {import('askargus-data-provider').TModelSpec} TModelSpec
 * @memberof typedefs
 */
...
/**
 * @exports FileSources
 * @typedef {import('askargus-data-provider').FileSources} FileSources
 * @memberof typedefs
 */
...
/**
 * @exports ImageFile
 * @typedef {import('askargus-data-provider').ImageFile} ImageFile
 * @memberof typedefs
 */

/**
 * @exports TMessageContentParts
 * @typedef {import('askargus-data-provider').TMessageContentParts} TMessageContentParts
 * @memberof typedefs
 */

/**
 * @exports StreamContentData
 * @typedef {import('askargus-data-provider').StreamContentData} StreamContentData
 * @memberof typedefs
 */

/**
 * @exports ActionRequest
 * @typedef {import('askargus-data-provider').ActionRequest} ActionRequest
 * @memberof typedefs
 */

/**
 * @exports Action
 * @typedef {import('askargus-data-provider').Action} Action
 * @memberof typedefs
 */

/**
 * @exports ActionMetadata
 * @typedef {import('askargus-data-provider').ActionMetadata} ActionMetadata
 * @memberof typedefs
 */

/**
 * @exports ActionAuth
 * @typedef {import('askargus-data-provider').ActionAuth} ActionAuth
 * @memberof typedefs
 */

/**
 * @exports DeleteFilesBody
 * @typedef {import('askargus-data-provider').DeleteFilesBody} DeleteFilesBody
 * @memberof typedefs
 */
...
/**
 * @exports MongoFile
 * @typedef {import('@askargus/data-schemas').IMongoFile} MongoFile
 * @memberof typedefs
 */

/**
 * @exports ISession
 * @typedef {import('@askargus/data-schemas').ISession} ISession
 * @memberof typedefs
 */

/**
 * @exports IBalance
 * @typedef {import('@askargus/data-schemas').IBalance} IBalance
 * @memberof typedefs
 */

/**
 * @exports IUser
 * @typedef {import('@askargus/data-schemas').IUser} IUser
 * @memberof typedefs
 */

/**
 * @exports IPluginAuth
 * @typedef {import('@askargus/data-schemas').IPluginAuth} IPluginAuth
 * @memberof typedefs
 */

/**
 * @exports IRole
 * @typedef {import('@askargus/data-schemas').IRole} IRole
 * @memberof typedefs
 */
 ...
 * @typedef {import('askargus-data-provider').EModelEndpoint} EModelEndpoint
 * @memberof typedefs
 */

/**
 * @exports TEndpointOption
 * @typedef {import('askargus-data-provider').TEndpointOption} TEndpointOption
 * @memberof typedefs
 */

/**
 * @exports TAttachment
 * @typedef {import('askargus-data-provider').TAttachment} TAttachment
 * @memberof typedefs
 */

/**
 * @exports AssistantCreateParams
 * @typedef {import('askargus-data-provider').AssistantCreateParams} AssistantCreateParams
 * @memberof typedefs
 */

/**
 * @exports AssistantUpdateParams
 * @typedef {import('askargus-data-provider').AssistantUpdateParams} AssistantUpdateParams
 * @memberof typedefs
 */

/**
 * @exports AssistantListParams
 * @typedef {import('askargus-data-provider').AssistantListParams} AssistantListParams
 * @memberof typedefs
 */

/**
 * @exports AssistantListResponse
 * @typedef {import('askargus-data-provider').AssistantListResponse} AssistantListResponse
 * @memberof typedefs
 */

/**
 * @exports ContentPart
 * @typedef {import('askargus-data-provider').ContentPart} ContentPart
 * @memberof typedefs
 */

/**
 * @exports StepTypes
 * @typedef {import('askargus-data-provider').StepTypes} StepTypes
 * @memberof typedefs
 */

/**
 * @exports TContentData
 * @typedef {import('askargus-data-provider').TContentData} TContentData
 * @memberof typedefs
 */
 ...
 * @typedef {import('askargus-data-provider').PartMetadata} PartMetadata
 * @memberof typedefs
 */
 ...
 * @typedef {import('askargus-data-provider').TAssistantEndpoint} TAssistantEndpoint
 * @memberof typedefs
 */

/**
 * @exports TAgentsEndpoint
 * @typedef {import('askargus-data-provider').TAgentsEndpoint} TAgentsEndpoint
 * @memberof typedefs
 */

/**
 * @exports Agent
 * @typedef {import('askargus-data-provider').Agent} Agent
 * @memberof typedefs
 */

/**
 * @exports TEphemeralAgent
 * @typedef {import('askargus-data-provider').TEphemeralAgent} TEphemeralAgent
 * @memberof typedefs
 */

/**
 * @exports TWebSearchKeys
 * @typedef {import('@askargus/data-schemas').TWebSearchKeys} TWebSearchKeys
 * @memberof typedefs
 */

/**
 * @exports AgentToolResources
 * @typedef {import('askargus-data-provider').AgentToolResources} AgentToolResources
 * @memberof typedefs
 */

/**
 * @exports AgentCreateParams
 * @typedef {import('askargus-data-provider').AgentCreateParams} AgentCreateParams
 * @memberof typedefs
 */

/**
 * @exports AgentUpdateParams
 * @typedef {import('askargus-data-provider').AgentUpdateParams} AgentUpdateParams
 * @memberof typedefs
 */

/**
 * @exports AgentListParams
 * @typedef {import('askargus-data-provider').AgentListParams} AgentListParams
 * @memberof typedefs
 */

/**
 * @exports AgentListResponse
 * @typedef {import('askargus-data-provider').AgentListResponse} AgentListResponse
 * @memberof typedefs
 */
 ...
 * @typedef {import('askargus-data-provider').TUpdateResourcePermissionsRequest} TUpdateResourcePermissionsRequest
 * @memberof typedefs
 */

/**
 * @exports TUpdateResourcePermissionsResponse
 * @typedef {import('askargus-data-provider').TUpdateResourcePermissionsResponse} TUpdateResourcePermissionsResponse
 * @memberof typedefs
 */

/**
 * @exports AppConfig
 * @typedef {import('@askargus/data-schemas').AppConfig} AppConfig
 * @memberof typedefs
 */

/**
 * @exports JsonSchemaType
 * @typedef {import('@askargus/data-schemas').JsonSchemaType} JsonSchemaType
 * @memberof typedefs
 */

/**
 * @exports MCPServers
 * @typedef {import('@askargus/api').MCPServers} MCPServers
 * @memberof typedefs
 */
...
/**
 * @exports MCPManager
 * @typedef {import('@askargus/api').MCPManager} MCPManager
 * @memberof typedefs
 */

/**
 * @exports MCPConnection
 * @typedef {import('@askargus/api').MCPConnection} MCPConnection
 * @memberof typedefs
 */

/**
 * @exports LCFunctionTool
 * @typedef {import('@askargus/api').LCFunctionTool} LCFunctionTool
 * @memberof typedefs
 */

/**
 * @exports FlowStateManager
 * @typedef {import('@askargus/api').FlowStateManager} FlowStateManager
 * @memberof typedefs
 */

/**
 * @exports LCAvailableTools
 * @typedef {import('@askargus/api').LCAvailableTools} LCAvailableTools
 * @memberof typedefs
 */

/**
 * @exports LCTool
 * @typedef {import('@askargus/api').LCTool} LCTool
 * @memberof typedefs
 */

/**
 * @exports FormattedContent
 * @typedef {import('@askargus/api').FormattedContent} FormattedContent
 * @memberof typedefs
 */
 ...
 * @typedef {import('@askargus/data-schemas').FunctionTool} FunctionTool
 * @memberof typedefs
 */
 ...
 * @property {string} messageId - The ID of the message (from AskArgus).
 ...
 * @typedef {import('askargus-data-provider').TForkConvoResponse} TForkConvoResponse
 * @memberof typedefs
 */

/**
 * @exports TForkConvoRequest
 * @typedef {import('askargus-data-provider').TForkConvoRequest} TForkConvoRequest
 * @memberof typedefs
 */

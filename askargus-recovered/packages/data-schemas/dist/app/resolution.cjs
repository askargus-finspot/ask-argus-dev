            ...
            for (const [key, value] of Object.entries(config.overrides)) {
                ...
                if (key === 'interface' &&
                    ...
                    for (const [field, fieldVal] of Object.entries(value)) {
                        if (!askargusDataProvider.INTERFACE_PERMISSION_FIELDS.has(field)) {
                            ...
                            for (const [sub, subVal] of Object.entries(fieldVal)) {
                                if (!askargusDataProvider.PERMISSION_SUB_KEYS.has(sub)) {
                                    uiOnly[sub] = subVal;
                                }
                            }
...
exports.mergeConfigOverrides = mergeConfigOverrides;

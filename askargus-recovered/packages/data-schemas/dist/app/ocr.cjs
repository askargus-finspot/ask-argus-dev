...
function loadOCRConfig(config) {
    ...
    return {
        ...
        baseURL,
        mistralModel,
        strategy: (_d = config === null || config === void 0 ? void 0 : config.strategy) !== null && _d !== void 0 ? _d : askargusDataProvider.OCRStrategy.MISTRAL_OCR,
    };
}

exports.loadOCRConfig = loadOCRConfig;
//# sourceMappingURL=ocr.cjs.map

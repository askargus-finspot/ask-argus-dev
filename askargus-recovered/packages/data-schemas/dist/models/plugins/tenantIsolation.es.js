...
if (process.env.TENANT_ISOLATION_STRICT &&
    ...
    logger.warn(`[TenantIsolation] TENANT_ISOLATION_STRICT="${process.env.TENANT_ISOLATION_STRICT}" ` +
...
export { applyTenantIsolation };
//# sourceMappingURL=tenantIsolation.es.js.map

...
function createSpendTokensMethods(_mongoose, transactionMethods) {
    ...
    async function spendTokens(txData, tokenUsage) {
        ...
        winston.debug(`[spendTokens] conversationId: ${txData.conversationId}${(txData === null || txData === void 0 ? void 0 : txData.context) ? ` | Context: ${txData === null || txData === void 0 ? void 0 : txData.context}` : ''} | Token usage: `, { promptTokens, completionTokens });
        ...
        try {
            ...
            if (prompt || completion) {
                winston.debug('[spendTokens] Transaction data record against balance:', {
                    user: txData.user,
                ...
                winston.debug('[spendTokens] No transactions incurred against balance');
            }
        }
        catch (err) {
            winston.error('[spendTokens]', err);
        }
    }
    /**
    ...
    async function spendStructuredTokens(txData, tokenUsage) {
        ...
        const { promptTokens, completionTokens } = tokenUsage;
        winston.debug(`[spendStructuredTokens] conversationId: ${txData.conversationId}${(txData === null || txData === void 0 ? void 0 : txData.context) ? ` | Context: ${txData === null || txData === void 0 ? void 0 : txData.context}` : ''} | Token usage: `, { promptTokens, completionTokens });
        let prompt, completion;
        try {
            if (promptTokens) {
            ...
            if (prompt || completion) {
                winston.debug('[spendStructuredTokens] Transaction data record against balance:', {
                    user: txData.user,
                    prompt: prompt === null || prompt === void 0 ? void 0 : prompt.prompt,
                    promptRate: prompt === null || prompt === void 0 ? void 0 : prompt.rate,
                    completion: completion === null || completion === void 0 ? void 0 : completion.completion,
                ...
                winston.debug('[spendStructuredTokens] No transactions incurred against balance');
            }
        }
        catch (err) {
            winston.error('[spendStructuredTokens]', err);
        }
...
exports.createSpendTokensMethods = createSpendTokensMethods;
//# sourceMappingURL=spendTokens.cjs.map

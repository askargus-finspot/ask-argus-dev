...
function createTxMethods(_mongoose, txDeps) {
     ...
     */
    function getPremiumRate(valueKey, tokenType, inputTokenCount) {
        var _a;
        ...
        return (_a = premiumEntry[tokenType]) !== null && _a !== void 0 ? _a : null;
    }
    /**
     * Retrieves the multiplier for a given value key and token type.
     */
    function getMultiplier({ model, valueKey, endpoint, tokenType, inputTokenCount, endpointTokenConfig, }) {
        var _a, _b, _c, _d, _e, _f;
        if (endpointTokenConfig && model) {
            return (_b = (_a = endpointTokenConfig === null || endpointTokenConfig === void 0 ? void 0 : endpointTokenConfig[model]) === null || _a === void 0 ? void 0 : _a[tokenType]) !== null && _b !== void 0 ? _b : defaultRate;
        }
        if (valueKey && tokenType) {
            ...
            return (_d = (_c = tokenValues[valueKey]) === null || _c === void 0 ? void 0 : _c[tokenType]) !== null && _d !== void 0 ? _d : defaultRate;
        }
        if (!tokenType || !model) {
            return 1;
        }
        ...
        return (_f = (_e = tokenValues[valueKey]) === null || _e === void 0 ? void 0 : _e[tokenType]) !== null && _f !== void 0 ? _f : defaultRate;
    }
    /**
     * Retrieves the cache multiplier for a given value key and token type.
     */
    function getCacheMultiplier({ valueKey, cacheType, model, endpoint, endpointTokenConfig, }) {
        var _a, _b, _c, _d, _e, _f;
        if (endpointTokenConfig && model) {
            return (_b = (_a = endpointTokenConfig === null || endpointTokenConfig === void 0 ? void 0 : endpointTokenConfig[model]) === null || _a === void 0 ? void 0 : _a[cacheType]) !== null && _b !== void 0 ? _b : null;
        }
        if (valueKey && cacheType) {
            return (_d = (_c = cacheTokenValues[valueKey]) === null || _c === void 0 ? void 0 : _c[cacheType]) !== null && _d !== void 0 ? _d : null;
        }
        if (!cacheType || !model) {
            return null;
        }
        ...
        return (_f = (_e = cacheTokenValues[valueKey]) === null || _e === void 0 ? void 0 : _e[cacheType]) !== null && _f !== void 0 ? _f : null;
    }
    return {
        tokenValues,
        premiumTokenValues,
...
exports.cacheTokenValues = cacheTokenValues;
exports.createTxMethods = createTxMethods;
exports.defaultRate = defaultRate;
exports.premiumTokenValues = premiumTokenValues;

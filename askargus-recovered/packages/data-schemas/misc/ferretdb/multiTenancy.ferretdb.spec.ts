 ...
 *
 * Validates whether FerretDB can handle AskArgus's multi-tenancy model
 ...
 *   PG_CONTAINER     — Docker container name for psql (default: askargus-ferretdb-postgres-1)
...
const PG_CONTAINER = process.env.PG_CONTAINER || 'askargus-ferretdb-postgres-1';
...
/** All 29 AskArgus schemas by Mongoose model name */

...
import type { Agent } from 'askargus-data-provider';
...
function createMocks(overrides?: {
  ...
  // extractAskArgusParams returns maxContextTokens when provided in model_parameters
  mockExtractAskArgusParams.mockReturnValue({
    resendFiles: false,
    maxContextTokens,

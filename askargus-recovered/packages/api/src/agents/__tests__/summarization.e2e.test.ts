 ...
 *
 * Exercises the FULL AskArgus -> agents pipeline:
 *   AskArgus's createRun (@askargus/api)
 *     -> agents package Run.create (@askargus/agents)
...
(hasAnthropic ? describe : describe.skip)('Anthropic Summarization E2E (AskArgus)', () => {
...
(hasOpenAI ? describe : describe.skip)('OpenAI Summarization E2E (AskArgus)', () => {
  jest.setTimeout(180_000);
...
(hasBothProviders ? describe : describe.skip)(
  'Cross-provider Summarization E2E (AskArgus)',
  () => {
    jest.setTimeout(180_000);

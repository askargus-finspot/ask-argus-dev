import { EModelEndpoint, extractEnvVariable, normalizeEndpointName } from 'askargus-data-provider';
import type { TCustomEndpoints, TEndpoint } from 'askargus-data-provider';

import { extractAskArgusParams } from './llm';

describe('extractAskArgusParams', () => {
  it('should return defaults when options is undefined', () => {
    const result = extractAskArgusParams(undefined);
  ...
  it('should return defaults when options is null', () => {
    const result = extractAskArgusParams();
  ...
  it('should extract all AskArgus params and leave model options', () => {
    const options = {
      resendFiles: false,
    ...
    const result = extractAskArgusParams(options);
  ...
  it('should handle null values for AskArgus params', () => {
    const options = {
      resendFiles: true,
      promptPrefix: null,
  ...
  it('should only extract known AskArgus params', () => {
    const options = {
      resendFiles: false,
  ...
  it('should not mutate the original options object', () => {
    ...
    extractAskArgusParams(options);

    // Original object should remain unchanged
    expect(options).toEqual(originalOptions);
  });

  it('should handle undefined values for optional AskArgus params', () => {
    const options = {
      resendFiles: false,

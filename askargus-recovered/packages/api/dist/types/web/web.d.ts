import { AuthType } from 'askargus-data-provider';
import type { TCustomConfig, TWebSearchConfig } from 'askargus-data-provider';
import type { TWebSearchKeys, TWebSearchCategories } from '@askargus/data-schemas';

...
import type { IPromptGroupDocument as IPromptGroup } from '@askargus/data-schemas';
 ...
 */
export declare function buildPromptGroupFilter({ name, category }: {
    name?: string;
    category?: string;
}): {
 ...
 */
export declare function filterAccessibleIdsBySharedLogic({ accessibleIds, searchShared, searchSharedOnly, publicPromptGroupIds, ownedPromptGroupIds, }: {

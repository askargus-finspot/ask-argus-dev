...
export type InputItem = SystemMessageItemParam | DeveloperMessageItemParam | UserMessageItemParam | AssistantMessageItemParam | FunctionCallItemParam | FunctionCallOutputItemParam | ReasoningItemParam | ItemReferenceParam;
/** Message output item */
...
/** Attachment content types for AskArgus extensions */
export interface AskArgusAttachmentContent {
...
/**
 * AskArgus attachment event - custom streaming event for file/image attachments
 * Follows Open Responses extension pattern with askargus: prefix
 */
export interface AskArgusAttachmentEvent extends BaseEvent {
    type: 'askargus:attachment';
    /** The attachment data */
    attachment: AskArgusAttachmentContent;
    /** Associated message ID */
    message_id?: string;
    /** Associated conversation ID */
    conversation_id?: string;
}
/** Union of all streaming events (including AskArgus extensions) */
export type ResponseEvent = ResponseCreatedEvent | ResponseInProgressEvent | ResponseCompletedEvent | ResponseFailedEvent | ResponseIncompleteEvent | OutputItemAddedEvent | OutputItemDoneEvent | ContentPartAddedEvent | ContentPartDoneEvent | OutputTextDeltaEvent | OutputTextDoneEvent | RefusalDeltaEvent | RefusalDoneEvent | FunctionCallArgumentsDeltaEvent | FunctionCallArgumentsDoneEvent | ReasoningDeltaEvent | ReasoningDoneEvent | ErrorEvent | AskArgusAttachmentEvent;

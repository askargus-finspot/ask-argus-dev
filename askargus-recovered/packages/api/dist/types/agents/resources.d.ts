...
import type { AgentToolResources, TFile } from 'askargus-data-provider';
import type { IMongoFile, AppConfig, IUser } from '@askargus/data-schemas';
 ...
 */
export declare const primeResources: ({ req, appConfig, getFiles, filterFiles, requestFileSet, attachments: _attachments, tool_resources: _tool_resources, agentId, }: {
    req: ServerRequest & {
        user?: IUser;
    };
    ...
    getFiles: TGetFiles;
    filterFiles?: TFilterFilesByAgentAccess | undefined;

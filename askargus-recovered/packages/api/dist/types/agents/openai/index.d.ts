/**
 * OpenAI-compatible API for AskArgus agents.
 *
 * This module provides an OpenAI v1/chat/completions compatible interface
 * for interacting with AskArgus agents remotely via API.
 *
 * @example
 * ```typescript
 * import { createAgentChatCompletion, listAgentModels } from '@askargus/api';
 *

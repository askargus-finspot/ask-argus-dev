import { Run, Providers } from '@askargus/agents';
import type { LCToolRegistry, GenericTool, RunConfig, IState, LCTool } from '@askargus/agents';
import type { Agent, SummarizationConfig } from 'askargus-data-provider';
 ...
 */
export declare function createRun({ runId, signal, agents, messages, requestBody, user, tokenCounter, customHandlers, indexTokenCountMap, summarizationConfig, initialSummary, calibrationRatio, streaming, streamUsage, }: {
    agents: RunAgent[];
    signal: AbortSignal;
    runId?: string;
    streaming?: boolean;

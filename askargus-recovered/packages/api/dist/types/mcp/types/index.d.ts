import { z } from 'zod';
import { Tools, SSEOptionsSchema, MCPOptionsSchema, MCPServersSchema, StdioOptionsSchema, WebSocketOptionsSchema, StreamableHTTPOptionsSchema } from 'askargus-data-provider';
...
import type { SearchResultData, UIResource, TPlugin } from 'askargus-data-provider';
...
export type Provider = 'google' | 'anthropic' | 'openai' | 'azureopenai' | 'openrouter' | 'xai' | 'deepseek' | 'ollama' | 'bedrock';
 ...
 * - `'yaml'`   — operator-defined in askargus.yaml, full trust, boot-time init

# Dynamic Theme System for @askargus/client
...
```bash
npm install @askargus/client
```

### 2. Wrap Your App with ThemeProvider

```tsx
import { ThemeProvider } from '@askargus/client';
...
module.exports = {
  content: [
    ...
    './node_modules/@askargus/client/dist/**/*.js',
  ],
  darkMode: ['class'],
  theme: {
    extend: {
...
```tsx
import { IThemeRGB } from '@askargus/client';
...
```tsx
import { useTheme } from '@askargus/client';
...
**After:**
```tsx
import { ThemeContext, ThemeProvider } from '@askargus/client';
```
...
```tsx
import { ThemeProvider, defaultTheme, darkTheme } from '@askargus/client';
...
This theme system is part of the @askargus/client package. 
...
describe('validateAzureGroups with modelGroupMap and groupMap', () => {
  ...
  it('should throw an error if environment variables are set but not configured', () => {
    const validConfigs: TAzureGroups = [
      {
        group: 'askargus-westus',
        apiKey: '${WESTUS_API_KEY}',
        instanceName: 'askargus-westus',
      ...
      {
        group: 'askargus-eastus',
        apiKey: '${EASTUS_API_KEY}',
        instanceName: 'askargus-eastus',
  ...
  it('should list all expected models in both modelGroupMap and groupMap', () => {
    ...
    // Check groupMap for 'askargus-westus'
    expect(groupMap).toHaveProperty('askargus-westus');
    expect(groupMap['askargus-westus']).toEqual(
    ...
    // Check groupMap for 'askargus-eastus'
    expect(groupMap).toHaveProperty('askargus-eastus');
    expect(groupMap['askargus-eastus']).toEqual(
      expect.objectContaining({
        apiKey: '${EASTUS_API_KEY}',
        instanceName: 'askargus-eastus',
        deploymentName: 'gpt-4-turbo',
    ...
    expect(azureOptions1).toEqual({
      ...
      azureOpenAIApiInstanceName: 'askargus-westus',
    ...
    expect(azureOptions2).toEqual({
      ...
      azureOpenAIApiInstanceName: 'askargus-eastus',

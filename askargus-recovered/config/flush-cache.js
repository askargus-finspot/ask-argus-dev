...
/**
 * AskArgus Cache Flush Utility
 *
 * This script flushes the cache store used by AskArgus, whether it's
...
DESCRIPTION:
  Flushes the cache store used by AskArgus. Automatically detects
...
async function restartRecommendation() {
  ...
  console.log('   consider restarting the AskArgus backend:');
  console.log('');
...
async function main() {
  ...
  console.log('🧹 AskArgus Cache Flush Utility');
  console.log('================================');

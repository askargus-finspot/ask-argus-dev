...
import { Permissions, SystemRoles } from 'askargus-data-provider';
import {
  OGDialog,
  OGDialogTitle,
  OGDialogContent,
  ...
  Switch,
  DropdownPopup,
} from '@askargus/client';
import type { Control, UseFormSetValue, UseFormGetValues } from 'react-hook-form';
import type { PermissionTypes } from 'askargus-data-provider';
                    ...
                    {showAdminWarning &&
                      ...
                      permission === Permissions.USE && (
                        <div className="mb-2 max-w-full whitespace-normal break-words text-sm text-red-600">
                          ...
                          {'\n'}
                          <a
                            href="https://www.askargus.ai/docs/configuration/askargus_yaml/object_structure/interface"
                            target="_blank"
                            rel="noreferrer"

...
import type { TConversation, TMessage, TFeedback } from 'askargus-data-provider';
import { EditIcon, Clipboard, CheckMark, ContinueIcon, RegenerateIcon } from '@askargus/client';
...
const HoverButtons = ({
  ...
  return (
    <div className="group visible flex flex-wrap items-center justify-center gap-1 self-end focus-within:outline-none lg:justify-start">
      <MessageMetadata message={message} isLast={isLast} />

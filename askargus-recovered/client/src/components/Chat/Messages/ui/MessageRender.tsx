...
function areMessageRenderPropsEqual(prev: MessageRenderProps, next: MessageRenderProps): boolean {
  ...
  return (
    ...
    prevMsg.promptTokens === nextMsg.promptTokens &&
    prevMsg.tokenCount === nextMsg.tokenCount &&
    prevMsg.totalTokens === nextMsg.totalTokens &&
    prevMsg.reasoningTokens === nextMsg.reasoningTokens &&

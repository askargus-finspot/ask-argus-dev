...
import { ThemeContext, Spinner, Button, isDark } from '@askargus/client';
import { useNavigate, useOutletContext, useLocation } from 'react-router-dom';
import { useRegisterUserMutation } from 'askargus-data-provider/react-query';
import { loginPage } from 'askargus-data-provider';
import type { TRegisterUser, TError } from 'askargus-data-provider';

...
jest.mock('askargus-data-provider', () => {
  const actualModule = jest.requireActual('askargus-data-provider') as any;
  return {
    ...actualModule,
    dataService: {
      updateAgent: jest.fn(),
...
jest.mock('askargus-data-provider/react-query', () => ({
...
// Import after mocks
import { dataService } from 'askargus-data-provider';

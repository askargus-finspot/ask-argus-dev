import { OGDialogTemplate, Input, Button, OGDialog } from '@askargus/client';
        ...
        main={
          <>
            <div className="mb-4 text-center font-medium">
              {localize('com_ui_askargus_code_api_title')}
            </div>
            <div className="mb-4 text-center text-sm">
              {localize('com_ui_askargus_code_api_subtitle')}
            </div>
            ...
            <div className="mb-6">
              ...
              <a
                href="https://code.askargus.ai/pricing"
                target="_blank"
              ...
              >
                {localize('com_ui_askargus_code_api_key')}
              </a>
            </div>

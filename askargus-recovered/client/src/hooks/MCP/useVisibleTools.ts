...
import type { TPlugin } from 'askargus-data-provider';
 ...
 * Separates regular AskArgus tools from MCP servers.
 *
 * @param selectedToolIds - Array of selected tool IDs
 * @param regularTools - Array of regular AskArgus tools
